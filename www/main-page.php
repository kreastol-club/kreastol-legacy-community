...
<head>
    ...
    <meta name="google-signin-client_id"
          content="565620529101-erafakpvn52m0nr40qn581dan2pnl463.apps.googleusercontent.com">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            <form id="lang" method="POST">
                <ul>
                    <li>
                        <button type="submit" name="lang" value="en"><img alt="en-flag" src="img/flag/en-flag.jpg">
                        </button>
                    </li>
                    <li>
                        <button type="submit" name="lang" value="jp"><img alt="jp-flag" src="img/flag/jp-flag.jpg">
                        </button>
                    </li>
                    <li>
                        <button type="submit" name="lang" value="rs"><img alt="rs-flag" src="img/flag/rs-flag.png">
                        </button>
                    </li>
                    <li>
                        <button type="submit" name="lang" value="hu"><img alt="hu-flag" src="img/flag/hu-flag.jpg">
                        </button>
                    </li>
                </ul>
            </form>
...
<div class="header">
    ...
    <div class="navbar">
        <ul>
            <li>
                <a href="main-page.php?a=gallery"><?php echo lang_check(array("Gallery", "画廊", "Galéria", "Galerija")) ?></a>
            </li>
            <li>
                <a href='main-page.php?a=posts'><?php echo lang_check(array("Posts", "投稿", "Posztok", "Postovi")) ?></a>
            </li>
            <li>
                <a href='main-page.php?a=calendar'><?php echo lang_check(array("Calendar", "カレンダー", "Naptár", "Kalendar")) ?></a>
            </li>
    ...
    <div class="log-part">
        ...
        if (!isset($_SESSION["username"])) {
            ...
            <ul>
                <li>
                    <button id="register-b"
                            onclick="window.location.href='register.php';"><?php echo lang_check(array(" Register", "登録する", " Regisztrálás", " Registracija")) ?></button>
                </li>
                <li>
                    <button onclick="window.location.href='login.php';"
                            id="login-b"><?php echo lang_check(array("Log In", "ログインする", "Bejelentkezés", "Prijavite se")) ?></button>
                </li>
            </ul>
            ...
            <ul>
                <li>
                    <form method="post">
                        <button type="submit" id="register-b"
                                name="profile"><?php echo lang_check(array("My Profile", "マイアカウント", "Én Fiókom", "Moj profil")) ?></button>
                    </form>
                </li>
                <li>
                    <button onclick="window.location.href='logout.php';"
                            id="login-b"><?php echo lang_check(array("Log Out", "ログアウト", "Kijelentkezés", "Odjaviti se")) ?></button>
                </li>
